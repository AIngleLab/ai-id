...
/// encode a byte buffer into basic aingle base32
...
/// decode an already sanitized aingle base32 string into a byte buffer
pub fn decode (data: &[u8]) -> crate::aiidResult<Vec<u8>> {
    let mut out: Vec<u8> = vec![];
